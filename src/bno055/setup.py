...
setup(
    ...
    data_files=[
        ...
        (os.path.join('share', package_name, 'launch'), glob('launch/bno055.launch.launch.py')),
        (os.path.join('share', package_name, 'config'), glob('bno055/params/bno055_params_i2c.yaml'))
    ],
